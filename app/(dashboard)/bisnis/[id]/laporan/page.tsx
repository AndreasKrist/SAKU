...
import { CapitalAccountsReport } from '@/components/reports/CapitalAccountsReport'
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Laporan laba rugi, arus kas, dan modal
        </p>
      </div>
      ...
      <Tabs defaultValue="profit-loss" className="w-full">
        ...
        <TabsContent value="capital" className="space-y-4">
          <CapitalAccountsReport businessId={params.id} />
        </TabsContent>
      </Tabs>
    </div>
  )
